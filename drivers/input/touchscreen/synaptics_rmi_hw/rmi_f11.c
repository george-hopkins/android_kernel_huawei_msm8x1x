...
#endif
	__ATTR(rezero, RMI_WU_ATTR, rmi_show_error, f11_rezero_store)
};
...
static int rmi_f11_initialize(struct rmi_function_container *fc)
{
	...
	*/
	...
	fc->data = f11;
	lcd_resolution.lcd_x = pdata->lcd_x;
	lcd_resolution.lcd_y = pdata->lcd_y;
	lcd_resolution.lcd_all = pdata->lcd_all;
